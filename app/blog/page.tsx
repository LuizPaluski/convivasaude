...
import { BLOG_POSTS, CATEGORY_CONFIG } from "@/lib/blog-data"
...
export default function BlogPage() {
  ...
  const filteredFeatured =
    activeCategory === "Todos" || activeCategory === featured.category ? featured : null
...
function ArticleCard({ post }: { post: (typeof BLOG_POSTS)[number] }) {
  ...
  if (!post.published) return <div key={post.slug}>{inner}</div>
